...
class AttendanceRepository {
  ...
  Future<List<AttendanceModel>> fetchHistory(String userId, {int limit = 30}) async {
  ...
  Future<void> checkIn() async {
    ...
    await callable.call(const {'action': 'check_in'});
  }

  Future<void> checkOut() async {
    final callable = _functions.httpsCallable('recordAttendance');
    await callable.call(const {'action': 'check_out'});
  }
